...
const Resume = () => {
  const downloadPDF = () => {
    ...
    const opt = {
      margin: 0,
      filename: "Suraj_Regmi_Resume.pdf",
  ...
  return (
    <div className="py-4">
      <div className="sticky top-0 bg-white z-50 flex justify-end max-w-4xl mx-auto p-4 shadow-md">
        <button
          onClick={downloadPDF}
      ...
      >
        ...
        <ResumeSection title="Professional Summary">
          <p className="text-sm text-gray-700">
            ...
            building scalable web applications and backend services using
            Node.js, React, and .NET. Proven ability to design and implement
            modular, maintainable systems across both frontend and backend.
            Experienced in RESTful APIs, PostgreSQL, MongoDB, and CI/CD
            workflows. Currently exploring Go and Next.js for advanced backend
            capabilities. Passionate about clean code, SOLID principles, and
        ...
        <ResumeSection title="Work Experience">
          <div className="mb-4">
            ...
            <ul className="list-disc pl-5 text-sm text-gray-700 mt-1">
              ...
              <li>
                Built frontend with React including sample forms, dashboards,
                and reports.
              </li>
              <li>
              ...
              <li>
                Implemented background services for high-volume report
                generation.
              </li>
              <li>
        ...
        <ResumeSection title="Client Projects">
          <ul className="list-disc pl-5 text-sm text-gray-700">
            <li>
              Oil Commander – LIMS for oil monitoring & fleet maintenance.
            </li>
            <li>
              Delphi – Drug discovery platform for a US biotech firm (Leapfrog).
            </li>
            <li>
              Online MCQ System – Angular-based SaaS exam portal (Bentray).
            </li>
            <li>
              FlexYear HR – Angular-based HR & payroll software (Bentray).
            </li>
          </ul>
        </ResumeSection>
